...
function About() {
  return (
    <div
      name="about"
      className="w-full min-h-screen md:pt-[2rem] text-white bg-[#001122]"
    >
      <div className="mx-auto px-10 pt-[4rem] pb-[2rem] flex flex-col justify-center max-[360px]:pt-[2rem] w-full max-w-screen-lg ">
