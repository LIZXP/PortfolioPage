    ...
    <div className="flex justify-between items-center w-full h-20 pb-5 text-red-400 px-4 fixed bg-gradient-to-r from-[#5d951f] via-[#001122] to-[#001122] z-50">
      <div>
        <svg
          ...
          className="mt-6 h-28 md:pl-10 hover:scale-105 duration-200 "
          version="1.0"
      ...
      <ul className="hidden md:flex pr-72">
        {links.map(({ link }, i) => (
          <li
            className="px-9 cursor-pointer capitalize text-[#f87171] font-extrabold hover:scale-105 duration-200 text-3xl items-center pt-1"
            key={i}
          >
            {link}
          </li>
      ...
      {nav && (
        <ul className="flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-[#5d951f] via-[#001122] to-[#001122] text-[#f87171] font-black">
          {links.map(({ link }, i) => (
            <li
