...
function NavBar() {
  ...
  return (
    <div className="flex justify-between items-center w-full h-20 text-red-400 px-4 fixed">
      <div>
        <svg
      ...
      <ul className="hidden md:flex pr-72">
        {links.map(({ link }, i) => (
          <li
            className="px-4 cursor-pointer capitalize text-salmon font-extrabold hover:scale-105 duration-200 text-4xl "
            key={i}
          >
            {link}
          </li>
